    ...
    <div className="bg-aurora relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-12">
      ...
      <div className="animate-fade-in relative w-full max-w-md">
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          <div className="bg-violet-gradient mb-4 flex h-12 w-12 items-center justify-center rounded-xl shadow-violet-glow">
            <Gavel className="h-6 w-6 text-primary-foreground" strokeWidth={2.4} />
          </div>
